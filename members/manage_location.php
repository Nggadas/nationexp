				...
				<div class="row">
					<div class="col-md-5 col-sm-6">
						<div class="calculate_title">
							<h2>Manage Pickup Location</h2>
							<p>View and manage your pickup location</p>
						</div>
						<?php if (empty($name) && empty($add) && empty($city) && empty($near) && empty($time)) { ?>
							<div class="calculat-button">
								<a href="set_pickup_location.php"><input type="button" class="calulate" value="ENTER YOUR PICKUP LOCATION"></a>
							</div>
						<?php } else { ?>
						<div class="calculate_form">
							<div style="margin-bottom: 13px; margin-left:20px">
								<strong style="font-size: 20px;">Name</strong>
								<br>
								<p style="font-size: 17px;"><?php echo $name; ?></p>
							</div>
							<div style="margin-bottom: 13px; margin-left:20px">
								<strong style="font-size: 20px;">Address</strong>
								<br>
								<p style="font-size: 17px;"><?php echo $add; ?></p>
							</div>
							<div style="margin-bottom: 13px; margin-left:20px">
								<strong style="font-size: 20px;">City</strong>
								<br>
								<p style="font-size: 17px;"><?php echo $city; ?></p>
							</div>
							<div style="margin-bottom: 13px; margin-left:20px">
								<strong style="font-size: 20px;">Nearest Bustop</strong>
								<br>
								<p style="font-size: 17px;"><?php echo $near; ?></p>
							</div>
							<div style="margin-bottom: 13px; margin-left:20px">
								<strong style="font-size: 20px;">Time</strong>
								<br>
								<p style="font-size: 17px;"><?php echo $time; ?></p>
							</div>
								<div class="calculat-button">
									<a href="editpickupinfo.php"><input type="button" class="calulate" value="EDIT INFO"></a>
								</div>
						</div>
					<?php } ?>
					</div>
