...
<html lang="en">
	...
	<body class="js1">
				...
				<div class="row">
					<div class="col-md-5 col-sm-6">
						<div class="calculate_title">
							<h2>Set Pickup Location</h2>
							<p>Enter your default pickup location</p>
						</div>
						<div id="errormsg" style="display:none; background-color: red; text-align: center; padding: 10px; margin: auto; width: 271px;">
							<h4 style="color: white"><span id="result"></span></h4>
						</div>
						<div id="successmsg" style="display:none; background-color: green; text-align: center; padding: 10px; margin: auto; width: 379px;">
						...
						<div class="calculate_form">
							<form>
								...
								<div class="single_calculate">
									<input type="text" name="near" id="near" required>
									<label>Nearest Bustop</label>
								</div>
								<div class="single_calculate">
									<input type="text" name="time" id="time" placeholder="HH:MM PM" title="HH:MM PM" required>
									<label>Time</label>
								</div>
								<div class="calculat-button">
									<input type="submit" class="calulate" value="SUBMIT" name="submit" id="submit">
								</div>
							</form>
						</div>
					</div>
		...
		<script src="resources/js/pickup.js"></script>
