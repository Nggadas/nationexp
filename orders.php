													...
													<?php do {?>
														...
														<?php if($myaccount_id){ ?>
															<tr>
																...
																<td><a href="edit_order?booking_no=<?php echo $b_booking_no; ?>" target="_blank"><button class="btn btn-default" title="Click here to edit the order">Edit Order</button></a></td>
															</tr>
														<?php } ?>
													<?php }while($val_tr_orders = mysql_fetch_array($sql_tr_orders)) ?>	
												</tbody>
										</table>
									</div>
								</div>
