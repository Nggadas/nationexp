...
<html lang="en">
	<head>
		...
		<title>Edit Delivery Type - NationExpress24 Delivery</title>
		<!--  bootstrap css -->
				...
				<div class="row">
					<div class="col-md-5 col-sm-6">
						<div class="calculate_title">
							...
							<p>You can edit delivery type details for <?php echo $delivery_type ?></p>
							<?php
                                if(!empty($error)){
						...
						<div class="calculate_form">
							<form method="post" autocomplete="off">
								...
								<div style="background: #e0e0d1; color: #000;" class="single_calculate">
									<input style="background: #e0e0d1; color: #000;" type="text" id="delivery_type" name="delivery_type" value="<?php echo $delivery_type ?>" readonly>
									<label>Delivery Type</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="additional_cost" name="additional_cost" value="<?php echo $additional_cost ?>">
									<label>Additional Cost</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="estimated_dt" name="estimated_dt" value="<?php echo $estimated_dt ?>">
									<label>Estimated Delivery Time</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="collection_st" name="collection_st" value="<?php echo $collection_st ?>">
									<label>Collection Starts</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="collection_et" name="collection_et" value="<?php echo $collection_et ?>">
									<label>Collection Ends</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="delivery_st" name="delivery_st" value="<?php echo $delivery_st ?>">
									<label>Delivery Starts</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="delivery_et" name="delivery_et" value="<?php echo $delivery_et ?>">
									<label>Delivery Ends</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="resume" name="resume" value="<?php echo $resume ?>">
									<label>Resume</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="stop" name="stop" value="<?php echo $stop ?>">
									<label>Stop</label>
								</div>
								<div class="single_calculate">
									<label style="width: 100%;">Description</label>
								</div>
								<textarea style="padding: 5px;" rows="5" cols="61" id="description" name="description" required><?php echo $description ?></textarea>
								<div class="single_calculate">
