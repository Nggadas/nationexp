						...
						<div class="calculate_form">
							<form method="post" autocomplete="off">
								<div style="background: #e0e0d1; color: #000;" class="single_calculate">
									<input style="background: #e0e0d1; color: #000;" type="text" id="delivery_city" name="delivery_city" value="<?php echo $delivery_city ?>" readonly>
									<label>Delivery City</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="zone_id" name="zone_id" value="<?php echo $zone_id ?>">
									<label>Zone ID</label>
								</div>
								<div class="single_calculate">
									<input type="text" id="collection_city" name="collection_city" value="<?php echo $collection_city ?>">
