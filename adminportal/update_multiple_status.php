...
<html lang="en">
	...
	<body class="js1">
						...
						<div class="calculate_form">
							<form method="post" autocomplete="off">
								...
								<div id="custom_status">
									<input style="width: 100%; height:50px; padding: 5px;" placeholder="Enter custom status" type="text" name="custom_status">
								</div>

								<!-- Cash Collected -->
								<div id="cash_toggle" style="display:none;">
									<button class="btn btn-default" style="color: #000;" disabled>Cash Collected?</button>
									<label class="radio-inline">
										<input type="radio" id"yes" name="toggle_options" value="yes">Yes
									</label>
									<label class="radio-inline">
										<input type="radio" id"no" name="toggle_options" value="no" checked>No
									</label>
								</div><br><br>
								...
								<input style="width: 100%; height:50px; padding: 5px; display: none;" placeholder="Enter amount collected" type="number" id="amount_collected" name="amount_collected">
		...
		<script src="resources/js/cash_collected.js"></script>
	</body>
