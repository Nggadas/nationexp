					...
					<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-center">
						<div class="single-pricing-table">
							...
							<ul class=price-list>
								...
								<a href="orders?status=out_for_delivery"><li>Out for delivery <span style="margin-left:10px;" class="badge"><?php echo $outfordelivery; ?></span></li></a>
								<a href="orders?status=undelivered"><li>Undelivered <span style="margin-left:10px;" class="badge"><?php echo $undelivered; ?></span></li></a>
