<?php
	...
	if(isset($_POST['submit_button'])){
		...
		$sql_email = mysqli_query("SELECT * FROM `register` WHERE `email` = '$email' AND `account_id`!='' ORDER BY ID DESC LIMIT 1");
		...
		$query_phone = mysqli_query("SELECT * FROM `register` WHERE `phone` = '$phone_no' AND `account_id`!='' ORDER BY ID DESC LIMIT 1");
