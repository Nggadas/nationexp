						...
						<div class="pricing-desc section-padding-two">
							<div class="pricing-desc-title">
								<div class="title">
									...
									<p>Here is where you will view the list of <font color="blue"><?php echo ucwords(strtoupper($type)); ?></font> customers </p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-lg-12 col-sm-4 col-xs-12 text-center">
						<div class="panel-body">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#recent" data-toggle="tab"><?php echo ucwords($type); ?> Customers</a>
								</li>
